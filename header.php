...
<header id="header" class="sticky-top">
    <div class="container d-flex align-items-center justify-content-between">
        <span class="logo"><a href="services"><img src="assets/img/logoresumemakingservice.webp" alt="logo"></a></span>
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="getstarted scrollto" href="tel:+61 480 005 916" target="_blank"><i class="bx bx-phone-call " style="font-size: 30px;"></i> +61480002193</a></li>
            </ul>
